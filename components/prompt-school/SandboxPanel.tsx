  ...
  return (
    <section aria-labelledby={`${uid}-title`} className="mt-10 k-card p-4 sm:p-6">
      ...
      <div className="mt-5 grid gap-x-8 lg:grid-cols-2">
        <div>
          <p className="mb-1 text-studio-ink k-clabel">The sample input</p>
        ...
        <div>
          <label htmlFor={`${uid}-prompt`} className="mb-1 mt-5 block text-studio-ink k-clabel lg:mt-0">Your prompt</label>
      ...
      {result && (
        <div className="mt-6 grid gap-x-8 lg:grid-cols-2" aria-live="polite">
          <div>
          ...
          {result.checklist.length > 0 && (
            <div>
              <p className="mb-1 mt-5 text-studio-ink k-clabel lg:mt-0">Check it yourself</p>
