...
- **Fixed Archive and the Dictionary feeling slow to load (PDL-091).** The Dictionary's own data was being fetched in three separate steps one after another instead of together, and every page was silently asking twice who you are instead of once. Both pages now load noticeably faster.
